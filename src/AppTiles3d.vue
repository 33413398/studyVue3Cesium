...
onMounted(() => {
  ...
  tiles3d.style = new Cesium.Cesium3DTileStyle({
    defines: {
      distance: // 着色器 -- 距离变量
        // feature 特征 cesium#longitude为信息窗口对应的属性名
        // 第一个参数传变量条件，第二个传以哪个点为中心，然后进行距离筛选
        "distance(vec2(${feature['cesium#longitude']},${feature['cesium#latitude']}),vec2(113.3191,23.109))", // 距离函数
    },
    color: {
      conditions: [
